...
export default function ListMusics() {
    ...
    const getData = async () => {
        setShowLoading(true);
        API.get(`/track/?page=${currentPage}`).then((response) => {
    ...
    useMemo(() => getData(), [trackToggle,currentPage]);
    ...
    return (
        <>
            ...
            <Pagination setCurrentPage={setCurrentPage} currentPage={currentPage} count={count} />
        </>
    )
};